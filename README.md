...
The following are some most widely used Python libraries for time series forecasting tasks:
  ...
  - **AutoTS**: AutoTS provides automated time series forecasting. It's designed to be easy to use and to handle a wide range of time series forecasting problems.
